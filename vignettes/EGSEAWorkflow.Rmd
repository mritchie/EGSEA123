...
# ReferencesShow in New WindowClear OutputExpand/Collapse Output
trying URL 'http://bioinf.wehi.edu.au/EGSEA/mam.rnaseq.rdata'
Content type 'unknown' length 1786017 bytes (1.7 MB)
==================================================
downloaded 1.7 MB
...
Show in New WindowClear OutputExpand/Collapse Output
  # table of gene set collections in EGSEAdata
| Database     | Collection            | Description                                            |
|:------------:|:---------------------:|:------------------------------------------------------:|
| MSigDB       | h Hallmarks           | Gene sets representing well-defined biological states. |
|              | c1 Positional         | Gene sets by chromosome and cytogenetic band.          |
